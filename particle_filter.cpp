...
void ParticleFilter::init(double x, double y, double theta, double std[]) {
	...
	double p_weight = 1.0/num_particles;
	cout<<"p_weight "<<p_weight;
	...
	for (int i = 0; i < num_particles; i++) {
		 ...
		 cout << "Sample " << i << " " << particles[i].id << " " << particles[i].x << " " << particles[i].y << " " << particles[i].theta<< " " << particles[i].weight <<endl;
